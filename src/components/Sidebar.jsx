...
const Sidebar = () => (
  <aside className="w-1/5 max-md:ml-0 max-md:w-full">
     <div className="p-10 text-base font-semibold text-black border-r-2 border-lightgray-100 border-solid max-md:px-5 max-md:mt-1 max-md:border-r-0 max-md:border-b-2">
